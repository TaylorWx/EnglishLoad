...
<head>
	...
	<title>Entries Online - Listening</title>
	<link rel="stylesheet" href="../dist/css/bootstrap.min.css">
	<link rel="stylesheet" href="../dist/css/font-awesome.min.css">
	<link rel="stylesheet" href="../dist/css/bootstrap-theme.css" media="screen">
	<link rel="stylesheet" type="text/css" href="../dist/css/isotope.css" media="screen" />
	<link rel="stylesheet" href="../dist/js/fancybox/jquery.fancybox.css" type="text/css" media="screen" />
	<link rel="stylesheet" href="../dist/css/style.css">
	<script type="text/javascript" src='../dist/js/jquery-1.9.1.min.js'></script>		
	<script type='text/javascript' src='../dist/js/jquery.min.js'></script>
	<script src="http://netdna.bootstrapcdn.com/bootstrap/3.0.0/js/bootstrap.min.js"></script>
	<script src="../dist/js/jquery.cslider.js"></script>
	<script src="../dist/js/jquery.isotope.min.js"></script>
	<script src="../dist/js/fancybox/jquery.fancybox.pack.js" type="text/javascript"></script>
...
<body>
 <jsp:include page="header.jsp" />
	...
	<header id="head" class="secondary">
        <div class="container">
        <h1>听力学习</h1>
            <a style="color: white;" href="${baseurl}fowardHearingIndex">听力训练</a>
        	&nbsp;&nbsp;|&nbsp;&nbsp;
        	<a style="color: white;" href="${baseurl}fowardHearingEvery"> 每日一句</a>
        </div>
    </header>
					...
					<div class="row">
						<nav id="filter" class="col-md-12 text-center">
							<ul>
								...
								<li><a href="#" class="btn-theme btn-small" data-filter=".webdesign">四、六级</a></li>
								<li><a href="#" class="btn-theme btn-small" data-filter=".photography">雅思、托福</a></li>
								<li><a href="#" class="btn-theme btn-small" data-filter=".print">专业英语</a></li>
							</ul>
						</nav>
						<div class="col-md-12">
							<div class="row">
