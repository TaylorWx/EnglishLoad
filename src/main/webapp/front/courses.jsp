...
<body>
	...
	<header id="head" class="secondary">
        <div class="container">
            <h1>课程学习</h1>
            <a style="color: white;" href="${baseurl}findCourse">视频</a>
        	&nbsp;&nbsp;|&nbsp;&nbsp;
        	<a style="color:white;" href="##">直播</a>
        </div>
    </header>
    ...
    <div class="container">
		...
		<ul class="list-unstyled video-list-thumbs row">
			<li class="col-lg-3 col-sm-4 col-xs-6">
				<a href="${baseurl}findCourse" title="Claudio Bravo, antes su debut con el Barça en la Liga">
