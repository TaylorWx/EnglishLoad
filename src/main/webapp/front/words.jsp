...
<body>
 <jsp:include page="header.jsp" />
	...
	<div class="container">
		<div class="row">
			<section class="col-sm-12 maincontent" id="everydayWord">
				<h3 style="font-weight: normal;font-family: 'Oswald', sans-serif;">每日一词</h3>
	...
	<div class="container">
		<div class="row">
			...
			<section class="col-sm-12 maincontent" id="selectedArticle">
				<h3 style="font-weight: normal;font-family: 'Oswald', sans-serif;">精美文章</h3>
				<p>
					<a href="${baseurl}article/showArticle?id=${article.articleId}"><i style="font-family: 'Oswald', sans-serif;font-size:17px;font-weight:400">《${article.title}》</i></a>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<section class="container">
		<div class="heading">
			<!-- Heading -->
			<!-- Heading -->
			<h3 style="font-weight: normal;font-family: 'Oswald', sans-serif;">单词分类</h3>
