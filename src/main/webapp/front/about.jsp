...
<body>
 <jsp:include page="header.jsp" />
 	<header id="head" class="secondary">
            <div class="container">
                    <h1>关于我们</h1>
                    <p>免费&nbsp;&nbsp;|&nbsp;&nbsp;<a style="color: white;"href="${baseurl}index.jsp">英语学习网站</a></p>
                </div>
    </header>
    ...
    <section class="team-content">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-3 col-xs-3" style="margin-top:80px;">
                    <!-- Team Member -->
                ...
                <div class="col-md-2 col-sm-3 col-xs-3" style="margin-top:80px;">
                    ...
                    <div class="team-member pDark">
                        ...
                        <div class="member-img">
                            <!-- Image  -->
                            <img class="img-responsive" src="../images/photo-5.jpg" alt="">
                        </div>
                        <!-- Member Details -->
                        <h4>陈晶</h4>
                        <!-- Designation -->
