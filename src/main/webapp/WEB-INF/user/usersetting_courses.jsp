                            ...
                            <c:forEach items="${courseList}"  var="course">
                                <li class="his-cou-list-item">
                                    <div class="his-cou-card">
                                        <a href="${baseurl}/courseplay/${course.courseId}?courseId=${course.courseId}" title="点击打开课程"><img src="/pic/${course.coursepic}"><span class="card-title">${course.coursename }</span></a>
                                    </div>
                                </li>
                               </c:forEach>    
                            </ul>
