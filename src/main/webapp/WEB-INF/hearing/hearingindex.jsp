	...
	<div class="word_box">
    	<div class="word_title">
        	<div class="title_img"><img src="images/img3.jpg"></div>
        		<div class="title_btn">
            		<a href="${baseurl }/backToHearingIndex">
...
<%--                     			<a href = "JavaScript:void(0)" onclick = "document.getElementById('light${hearingCustom.hearingId}').style.display='block';document.getElementById('fade').style.display='block'">   查看</a>
 --%> 		                
 								<a data-toggle="modal" href="#orgiText${hearingCustom.hearingId}">查看</a>
							</div>
                    		<div class="word_main_list_C">
                    			<a href="#transText${hearingCustom.hearingId}" data-toggle="modal">查看</a>
<%--                          		<a href = "JavaScript:void(0)" onclick = "document.getElementById('translate${hearingCustom.hearingId}').style.display='block';document.getElementById('fade').style.display='block'">   查看</a>         
 --%>                   	</div>
					...
					<div class="modal fade" id="orgiText${hearingCustom.hearingId}" tabindex="-1" role="dialog" aria-labelledby="orgiTextLabel" aria-hidden="true" data-back-drop="static">
						<div class="modal-dialog">
               				<div class="modal-content">
                   				<div class="modal-header btn-success">
                   					<button type="button" class="close" data-dismiss="modal" aria-label="close"><span>×</span></button>
                   					<h4 class="modal-title" id="orgiTextLabel">听力原文</h4>
                   				</div>
                   				<div class="modal-body">
                   					<h4>${hearingCustom.hearingtitle}</h4>
                   					<p>${hearingCustom.hearingeng}</p>
                   				</div>
                   				<div class="modal-footer">
                   					<a href="#" class="btn btn-success" data-dismiss="modal">确 认</a>
                   				</div>
                   			</div>
                   		</div> 
                   	</div>
           
        			<div class="modal fade" id="transText${hearingCustom.hearingId}" tabindex="-1" role="dialog" aria-labelledby="orgiTextLabel" aria-hidden="true" data-back-drop="static">
						<div class="modal-dialog">
               				<div class="modal-content">
                   				<div class="modal-header btn-success">
                   					<button type="button" class="close" data-dismiss="modal" aria-label="close"><span>×</span></button>
                   					<h4 class="modal-title" id="orgiTextLabel">听力译文</h4>
                   				</div>
                   				<div class="modal-body">
                   					<h4>${hearingCustom.hearingtitle}</h4>
                   					<p>${hearingCustom.hearingch}</p>
                   				</div>
                   				<div class="modal-footer">
                   					<a href="#" class="btn btn-success" data-dismiss="modal">确 认</a>
                   				</div>
...
<a href = "javascript:void(0)" onclick = "document.getElementById('translate${hearingCustom.hearingId}').style.display='none';document.getElementById('fade').style.display='none'">点这里关闭本窗口</a></div> 
        <div id="fade" class="black_overlay"></div>  --%>
			...
			<div class="word_list_page_num">
				<a href="${baseurl}/fowardHearingIndex?page=${page.firstPage}">
				...
				<c:choose>
					...
					<c:otherwise>
						<a href="${baseurl}/fowardHearingIndex?page=${page.prePage}">
						<span class="word_list_page_num_hover" style="cursor: pointer;">上一页</span></a>
					</c:otherwise>
				</c:choose>
				<c:choose>
					...
					<c:otherwise>
						<a href="${baseurl}/fowardHearingIndex?page=${page.nextPage}">
						<span class="word_list_page_num_hover" style="cursor: pointer">下一页</span></a>
					</c:otherwise>
				</c:choose>
				<a href="${baseurl}/fowardHearingIndex?page=${page.lastPage}">
				<span class="word_list_page_num_hover">尾页</span></a>
			</div>
			<div class="word_footer"></div>
		</div>  
	</div>
</body>
</html>