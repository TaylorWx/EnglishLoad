...
<head>
    ...
    <script type="text/javascript">
      ...
      {
        timer=setTimeout("window.location.href='backToIndex'", duration);
        interval();
      }
...
<div class="head"><img alt="起点网校logo" src="images/logo.png">
    <div class="cont">
        <h2>${message}</h2>
        <h3><span id="timeout">5</span>秒钟后将为您跳转到<a href="backToIndex">网站首页</a></h3>
    </div>
    <div class="footer">
        <script type="text/javascript" src="backToIndex"></script>
