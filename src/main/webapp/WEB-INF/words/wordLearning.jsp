                ...
                <div class="word_footer_scb_box" style="display:none">
	                <div class="word_footer_scb_add">
	                    <a href="javascript:;" class="word_footer_scb_add_t" sid=""></a>
	                           	添加到
	                    <div class="word_footer_scb_add_l" style=""></div>
	                </div>
	                <p>
	                    <a class="word_list_lable default_add_after" onclick="check($(this))" title="之后也默认添加到该生词本中" href="###"></a>
	                        	之后也默认添加到该生词本中
	                </p>
