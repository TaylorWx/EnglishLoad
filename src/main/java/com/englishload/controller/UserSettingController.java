...
public class UserSettingController {
	...
	public String userWordbooksAdd(Model model,WordbooksCustom wordbooksCustom){
		Subject subject = SecurityUtils.getSubject();
		ActiveUser activeUser = (ActiveUser) subject.getPrincipal();
		int userId=activeUser.getUserid();
		wordbooksCustom.setUserId(userId);
		int add=wordbooksService.createWordbooks(wordbooksCustom);
	...
	public ModelAndView userwordbooks(int wbookId,@RequestParam(required=true,defaultValue="1") Integer page,
