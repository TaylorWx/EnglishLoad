...
//	@RequiresPermissions("user:userlist")
	...
	//根据课程id删除课程内容，课程所关联的表也要一起删除
	@RequestMapping("deleteCouresByCourseId")
	public String deleteCouresByCourseId(@RequestParam(value = "courseId") Integer courseId){
		courseService.deleteByPrimaryKey(courseId);
		
		return "redirect:/fowardCourse";
	}
